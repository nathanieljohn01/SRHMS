            ...
            <h5 class="font-weight-bold mb-2">Search Patient:</h5>
                <div class="input-group mb-3">
                    <div class="position-relative w-100">
                        ...
                        <!-- Input Field -->
                        <input class="form-control" type="text" id="combinedSearchInput" onkeyup="filterUrinalysis()" placeholder="Search" style="padding-left: 35px; padding-right: 35px;">
                        <!-- Clear Button -->
                            ...
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" style="                                
                                    ...
                                    <?php if ($can_print): ?>
                                        ...
                                        <form action="generate-urinalysis.php" method="get" class="p-2">
                                    ...
                                    <?php if ($editable): ?>
                                        <a class="dropdown-item" href="#" onclick="return confirmDelete('<?php echo $row['urinalysis_id']; ?>')"><i class="fa fa-trash m-r-5"></i> Delete </a>
                                    <?php else: ?>
