...
if (isset($_GET['query'])) {
    ...
    $result = mysqli_query($connection, "SELECT id, medicine_name, medicine_brand, quantity, price, expiration_date FROM tbl_medicines WHERE medicine_name LIKE '%$query%' OR medicine_brand LIKE '%$query%'");
