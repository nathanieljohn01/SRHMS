...
$pending_query = "SELECT SUM(total_due) as total FROM (
    SELECT total_due FROM tbl_billing_inpatient WHERE deleted = 0 AND status = 'Pending'
    UNION ALL
    SELECT total_due FROM tbl_billing_hemodialysis WHERE deleted = 0 AND status = 'Pending'
    UNION ALL
    SELECT total_due FROM tbl_billing_newborn WHERE deleted = 0 AND status = 'Pending'
) as pending_totals";

$paid_query = "SELECT SUM(total_due) as total FROM (
    SELECT total_due FROM tbl_billing_inpatient WHERE deleted = 0 AND status = 'Paid'
    UNION ALL
    SELECT total_due FROM tbl_billing_hemodialysis WHERE deleted = 0 AND status = 'Paid'
    UNION ALL
    SELECT total_due FROM tbl_billing_newborn WHERE deleted = 0 AND status = 'Paid'
) as paid_totals";
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="dash-widget">
                    ...
                    $query = "SELECT COUNT(*) as total FROM (
                        SELECT billing_id FROM tbl_billing_inpatient WHERE deleted = 0
                        UNION ALL
                        SELECT billing_id FROM tbl_billing_hemodialysis WHERE deleted = 0
                        UNION ALL
                        SELECT billing_id FROM tbl_billing_newborn WHERE deleted = 0
                    ) as combined_billing";
                    ...
                    <div class="dash-widget-info text-right">
                        ...
                        <span class="widget-title1">Total Billing</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="dash-widget">
                    ...
                    <?php
                    $query = "SELECT SUM(total_due) as total FROM (
                        SELECT total_due FROM tbl_billing_inpatient WHERE deleted = 0
                        UNION ALL
                        SELECT total_due FROM tbl_billing_hemodialysis WHERE deleted = 0
                        UNION ALL
                        SELECT total_due FROM tbl_billing_newborn WHERE deleted = 0
                    ) as combined_revenue";
                    $result = mysqli_query($connection, $query);
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="dash-widget">
                    ...
                    <?php
                    $query = "SELECT COUNT(*) as total FROM (
                        SELECT billing_id FROM tbl_billing_inpatient WHERE deleted = 0 AND status = 'Pending'
                        UNION ALL
                        SELECT billing_id FROM tbl_billing_hemodialysis WHERE deleted = 0 AND status = 'Pending'
                        UNION ALL
                        SELECT billing_id FROM tbl_billing_newborn WHERE deleted = 0 AND status = 'Pending'
                    ) as pending_payments";
                    $result = mysqli_query($connection, $query);
                    ...
                    <div class="dash-widget-info text-right">
                        ...
                        <span class="widget-title3">Pending Bills</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="dash-widget">
                    ...
                    <?php
                    $query = "SELECT COUNT(*) as total FROM (
                        SELECT billing_id FROM tbl_billing_inpatient WHERE deleted = 0 AND status = 'Paid'
                        UNION ALL
                        SELECT billing_id FROM tbl_billing_hemodialysis WHERE deleted = 0 AND status = 'Paid'
                        UNION ALL
                        SELECT billing_id FROM tbl_billing_newborn WHERE deleted = 0 AND status = 'Paid'
                    ) as paid_bills";
                    $result = mysqli_query($connection, $query);
                    ...
                    <div class="dash-widget-info text-right">
                        ...
                        <span class="widget-title4">Paid Bills</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title d-inline-block">Billing Distribution</h4>
                        <div class="float-right">
...
// Data fetcher
function fetchBillingData(timeRange, dataType) {
    return $.ajax({
        url: 'fetch_billing_data.php',
        type: 'GET',
        dataType: 'json',
...
function initRevenueChart(timeRange = 'monthly') {
    ...
    fetchBillingData(timeRange, 'revenue').then(data => {
...
function initDistributionChart(timeRange = 'monthly') {
    ...
    Promise.all([
        fetchBillingData(timeRange, 'inpatient'),
        fetchBillingData(timeRange, 'hemodialysis'),
        fetchBillingData(timeRange, 'newborn')
    ]).then(results => {
