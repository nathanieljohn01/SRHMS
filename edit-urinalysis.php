            ...
            <div class="col-lg-10 offset-lg-1">
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" step="0.001" min="1.000" max="1.050" name="specific_gravity" id="specific_gravity" value="<?php echo htmlspecialchars($urinalysis_data['specific_gravity']); ?>">
                    </div>
                    <div class="form-group">
