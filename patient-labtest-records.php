...
if (isset($_GET['patient_id'])) {
    ...
    if ($num_records == 0) {
        ...
        <script>
            Swal.fire({
                title: 'No Lab Test Records Found',
                icon: 'info',
...
<div class="page-wrapper">
    <div class="content">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Lab Test Records for Patient</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input id="patientName" class="form-control" type="text" value="<?php echo htmlspecialchars($patient_name); ?>" readonly>
                </div>
            </div>
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="lab-order-patients.php" class="btn btn-primary btn-rounded">Back</a>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="datatable table table-hover" id="labTestTable">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?php echo $lab_test_row['lab_test']; ?></td>
                            <td><?php echo $lab_test_row['lab_department']; ?></td>
                            <td><?php echo ($lab_test_row['stat'] == 'STAT') ? '<span class="custom-badge status-red">STAT</span>' : $lab_test_row['stat']; ?></td>
                            <td><?php echo $lab_test_row['status']; ?></td>
