    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="add-radiology.php" class="btn btn-primary float-right"><i class="fa fa-plus"></i> Add Order</a>
            </div>
        </div>
            ...
            <table class="datatable table table-hover" id="patientTable">
                ...
                <tbody>
                   ...
                   $fetch_patients_query = mysqli_query($connection, "SELECT patient_id, patient_type, first_name, last_name, dob, gender, date_time FROM tbl_patient WHERE patient_type IN ('Inpatient', 'Outpatient') ORDER BY last_name ASC") or die(mysqli_error($connection));
                    ...
                    ?>
                        <tr class="clickable-row" data-href="patient-radtest-records.php?patient_id=<?php echo htmlspecialchars($patient_row['patient_id']); ?>">
