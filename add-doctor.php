...
include('includes/connection.php');
    ...
    if(isset($_REQUEST['add-doctor']))
    {
      ...
      $insert_query = mysqli_query($connection, "insert into tbl_employee set first_name='$first_name', last_name='$last_name', specialization='$specialization', username='$username', emailid='$emailid', password='$pwd',  dob='$dob', employee_id='$employee_id', joining_date = '$joining_date', gender='$gender', address='$address', phone='$phone',  bio='$bio', role=2, status='$status' profile_picture='$profile_picture'");
            ...
            <div class="content">
                ...
                <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form method="post" enctype="multipart/form-data"> <!-- Note the addition of enctype attribute for file upload -->
