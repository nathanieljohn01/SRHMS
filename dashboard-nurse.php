        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                ...
                <div class="dash-widget">
                    ...
                    <?php
                    $fetch_query = mysqli_query($connection, "select count(*) as total from tbl_patient where patient_type = 'Outpatient'");
                    $doc = mysqli_fetch_row($fetch_query);
                    ?>
                    <div class="dash-widget-info text-right">
                        <h3><?php echo $doc[0]; ?></h3>
                        <span class="widget-title1">Outpatient <i class="fa fa-check" aria-hidden="true"></i></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                ...
                <div class="dash-widget">
                    ...
                    <?php
                    $fetch_query = mysqli_query($connection, "select count(*) as total from tbl_patient where patient_type = 'Inpatient'");
                    $doc = mysqli_fetch_row($fetch_query);
                    ?>
                    <div class="dash-widget-info text-right">
                        <h3><?php echo $doc[0]; ?></h3>
                        <span class="widget-title2">Inpatient <i class="fa fa-check" aria-hidden="true"></i></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                ...
                <div class="dash-widget">
                    ...
                    <?php
                    $fetch_query = mysqli_query($connection, "select count(*) as total from tbl_patient where patient_type = 'Hemodialysis'");
                    $doc = mysqli_fetch_row($fetch_query);
                    ?>
                    <div class="dash-widget-info text-right">
                        <h3><?php echo $doc[0]; ?></h3>
