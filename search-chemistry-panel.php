...
if (isset($_GET['query'])) {
    ...
    $query_sql = "SELECT DISTINCT id, patient_name FROM tbl_laborder WHERE lab_test = 'Chemistry Panel' AND status = 'Completed' AND patient_name LIKE ?";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            // Output each patient as a list item
